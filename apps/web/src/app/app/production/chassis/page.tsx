...
const INSTALADOR_URL =
  'https://github.com/adminadmin-AI/Avequi/releases/download/openclaw-v1.0.0/Gravadora_de_Chassi_v1.0.0.exe';
            ...
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <ol className="list-decimal space-y-1 pl-5 text-content-secondary">
                  <li>Execute o <span className="font-mono text-xs">Gravadora_de_Chassi_*.exe</span> baixado acima: ele instala em <span className="font-mono text-xs">C:\OpenClaw</span> e cria o atalho <strong>“Marcadora de Chassi”</strong> na área de trabalho (não precisa de administrador)</li>
