...
async function main() {
  ...
  const taxRules = [
    ...
    { companyId: matriz.id, operationType: TaxOperationType.VENDA_INTERESTADUAL, ncm: '87163900', ufOrigem: 'PR', ufDestino: 'SP', cfop: '6101', icmsCst: '00', icmsAliquota: 12, icmsInternaDestino: 18, ipiCst: '51', ipiAliquota: 0, pisCst: '49', pisAliquota: 0, cofinsCst: '99', cofinsAliquota: 0, cClassTrib: '000001', cbsCst: '000', cbsAliquota: 0.9, ibsUfCst: '000', ibsUfAliquota: 0.1, ibsMunCst: '000', ibsMunAliquota: 0, description: 'Reboque NCM 8716 — PR→SP (ICMS 12%, interna SP 18%)', priority: 10 },
    ...
    { companyId: matriz.id, operationType: TaxOperationType.VENDA_INTERESTADUAL, ncm: '87163900', ufOrigem: 'PR', ufDestino: 'RJ', cfop: '6101', icmsCst: '00', icmsAliquota: 12, icmsInternaDestino: 20, ipiCst: '51', ipiAliquota: 0, pisCst: '49', pisAliquota: 0, cofinsCst: '99', cofinsAliquota: 0, cClassTrib: '000001', cbsCst: '000', cbsAliquota: 0.9, ibsUfCst: '000', ibsUfAliquota: 0.1, ibsMunCst: '000', ibsMunAliquota: 0, description: 'Reboque NCM 8716 — PR→RJ (ICMS 12%, interna RJ 20%)', priority: 10 },
