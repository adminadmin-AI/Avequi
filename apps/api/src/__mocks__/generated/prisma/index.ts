...
// Operações fiscais do motor de impostos (TaxRule.operationType)
export enum TaxOperationType {
  ...
  TRANSFERENCIA_INTERESTADUAL = 'TRANSFERENCIA_INTERESTADUAL',
...
export enum AlertType {
  ...
  CRM_SLA_WARNING = 'CRM_SLA_WARNING',
  CRM_SLA_ESCALATION = 'CRM_SLA_ESCALATION',
}

export enum RenaveOperationType {
  BIN_REGISTER = 'BIN_REGISTER',
  STOCK_IN = 'STOCK_IN',
  SALE_OUT = 'SALE_OUT',
  ATPVE_PDF = 'ATPVE_PDF',
  CANCEL_SALE_OUT = 'CANCEL_SALE_OUT',
  RETURN_MANUFACTURER = 'RETURN_MANUFACTURER',
}

export enum RenaveOperationStatus {
  PENDING = 'PENDING',
  PROCESSING = 'PROCESSING',
  REGISTERED = 'REGISTERED',
  STOCK_CONFIRMED = 'STOCK_CONFIRMED',
  SALE_INTENT_CREATED = 'SALE_INTENT_CREATED',
  ACTIVE = 'ACTIVE',
  ERROR = 'ERROR',
  CANCELLED = 'CANCELLED',
}
...
export enum PermissionChangeType {
  ...
  PERMISSION_GRANTED = 'PERMISSION_GRANTED',
  PERMISSION_REVOKED = 'PERMISSION_REVOKED',
  // #352 — eventos de ciclo de vida de perfil
